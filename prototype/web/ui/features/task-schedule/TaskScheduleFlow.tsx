...
import type { AcceptRequest } from '../../../../src/accept.js'
import type { CognitiveLoad, Importance, ProposalField, Splittability, TaskCategory } from '../../../../src/types.js'
import {
  CATEGORY_LABEL,
  IMPORTANCE_LABEL,
  durationLabel,
...
function TaskBubbleScreen({ engine }: { engine: Engine }) {
...
export function TaskScheduleFlow({ engine }: { engine: Engine }) {
  switch (engine.screen) {
    case '01-task-bubble':
      return <TaskBubbleScreen engine={engine} />
    case '06-ai-analysis':
